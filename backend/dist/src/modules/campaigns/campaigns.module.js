...
const campaigns_controller_1 = require("./infrastructure/campaigns.controller");
const campaign_dispatch_processor_1 = require("./infrastructure/campaign-dispatch.processor");
...
exports.CampaignsModule = CampaignsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            bullmq_1.BullModule.registerQueue({ name: 'campaign-dispatch' }),
            whatsapp_module_1.WhatsappModule,
        ],
        controllers: [campaigns_controller_1.CampaignsController],
        providers: [campaigns_service_1.CampaignsService, campaign_dispatch_processor_1.CampaignDispatchProcessor],
